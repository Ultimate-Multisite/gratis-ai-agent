...
* Fix: continue reset after plugin activation failures
* Fix: client tool refresh and job error reporting
* Improved: Preserve local WP plugins during reset
* Improved: test: add strict types to tool capabilities test
* Fix: intercept raw text tool calls
* Fix: live homepage content reflection
* Improved: auto-recover: orphaned worker branch for #2087
* Fix: register active jobs cleanup cron
* New: add file outline and ranged reads
* New: add REST meta diagnostics ability
* New: replace wp-cli shell execution with native dispatcher
* Fix: keep health diagnostics read-only
* Improved: wip: document read vendor recovery
* Improved: wip: map contributor insight 2081
* Fix: feedback replay tool flows
* Improved: docs: clarify fatal read recovery
* Improved: docs: map contributor insight issue 2074
* Fix: stop theme build after scaffold permission denial
* Improved: docs: require final theme quality review
* Improved: docs: map contributor insight issue 2066
* Improved: docs: clarify vendor read fatal triage
* Improved: docs: mark t235 ability discovery complete
* Fix: WordPress abilities debug notices
* Fix: align Superdav service registration
* Improved: docs: clarify fatal-error symlink triage
* New: ingest Superdav AI model metadata
* Improved: docs: map issue 2060 contributor insight
* Improved: Implement local WordPress worktree testing and benchmark summaries
* New: update managed Superdav AI connector UX
* New: add managed Superdav AI connector
* Fix: Superdav provider bootstrap timing
* Improved: docs: clarify fatal read recovery
* Improved: docs: map issue 2050 contributor insights
* New: add safe crash resume checkpoints
* Fix: allow multisite admin URL helpers
* Fix: guard empty global styles updates
* Fix: protect block template hero edits
* Fix: align onboarding activity detection
* Fix: preserve cloud provider type in runtime stub
* Fix: type Superdav request data
* Improved: docs: clarify contributor insight source mapping
* Fix: share onboarding sessions across admins
* Fix: detach process requests on litespeed
* Improved: wip: harden skill usage telemetry
* Improved: docs: guide missing-read fatal recovery
* Improved: docs: clarify contributor insight mapping
* Fix: surface interrupted agent jobs
* Fix: prevent Woo MCP from hanging REST requests
...
* New: register first-party Superdav AI provider
* Fix: avoid unavailable stock image providers
* Fix: improve ability discovery aliases
* Improved: wip: protect hidden todo ref updates
* Fix: harden TODO issue sync parsing
* Improved: wip: ignore hidden TODO examples
* Improved: test: cover stock image fallback after requested source failure
* Improved: wip: support skill manifest wrapper
* Improved: Add frontend onboarding live widget
* Improved: docs: clarify contributor insight review responses
* Fix: strip database ability from wporg build
* Fix: retire separate theme builder agent
* Fix: separate agent messages from tool calls
* Fix: strip wporg compatibility shims
* Fix: prefix knowledge cron hook
* Improved: docs: include option prefix allowlist verification
* Fix: default-deny option writes
* Fix: enable frontend widget by default
* Fix: allow stock image import by id without keyword
* Improved: docs: clarify missing read recovery
* Improved: docs: map contributor insight service surfaces
* Fix: prepare database ability queries
* Fix: harden REST permission callbacks
* Fix: resolve wporg path location findings
* Fix: store logo SVGs in plugin upload folder
* Improved: docs: expand external service disclosures
* Improved: docs: disclose GitHub skills sync service
* Improved: docs: improve contributor insight guidance
* Improved: wip: document contributor insight tool recovery
* Fix: flush reflection events on terminal errors
* Improved: wip: publish reflection bus global
* Improved: docs: improve contributor insight triage guidance
* Improved: wip: document headless recovery patterns
* New: add current post live preview reflector
* New: add affected payloads to content mutators
* New: add global styles reflector
* New: harden frontend widget delivery
* New: add fallback reload toast reflector
* New: add navigation menu reflector
* Improved: spike(frontend): wire post-tool reflection bus (Phase 1)
* Fix: create verifiable WPForms contact forms
* Improved: docs: clarify contributor insight follow-through
* Improved: docs: add file read recovery guidance
* Improved: wip: update skills sync help count
* Fix: move direct access guards to file top
* Fix: document core block enqueue hooks
* Fix: use literal filter hook names
* Improved: docs: shorten 1.16.2 upgrade notice
* Fix: pre-submission wporg cleanup — %i identifier + reviewer note
* Improved: test: isolate flaky PHPUnit ability fixtures
* Improved: drop dev-only files + let wporg-review run from worktrees
* Improved: t276: unify Setup Assistant + Theme Builder into one fast-path onboarding agent
* Fix: canonicalize block theme skill
* Improved: build(wporg): add npm run wporg-review mirroring the .org AI review pipeline
* Improved: security(abilities): enforce WP core caps on all ability permission_callbacks via dual-gate
* New: gate + harden user create/role-change abilities; exclude from wp.org build
* New: exclude WP-CLI benchmark suite from the WordPress.org distribution
* Improved: bump automattic/jetpack-autoloader 5.0.17 -> 5.0.18
* Fix: remove third-party provider hostnames flagged by WP.org reviewer
* Improved: ci: validate wporg build strip lists
* Improved: docs: carve out dispatcher ability namespaces
* Improved: security(abilities): gate + strip + tighten caps for wp-rest/wp-cli dispatchers
* Fix: redact auth keys and salts from every option-read surface
* Fix: exclude scaffolder + extract inline JS/CSS + prefix polyfill
* Fix: persist a fresh session row per wp sd-ai-agent prompt invocation
* Fix: handle PluginBuilder PHPUnit sandbox fallback
* Improved: docs: clarify headless gh write guidance
* Improved: wip: document contributor insight completion
* New: plugin-discovery guidance + pending session fixes
* Improved: docs: document headless GitHub write guardrails
* Improved: docs: document REST hardening guidance
* Improved: test: isolate tool discovery ability registry mutation
* Fix: rename block validation repairs property
* Fix: hide unavailable wp-cli tool
* Fix: make adev-005 file benchmark use accessible file
* Fix: align ability routing with direct tool list
* Fix: make as-010 benchmark repeatable
* Fix: replay benchmark plugin lifecycle callbacks
* Fix: enforce block validation repair guard
* Fix: log create-post changes
* Fix: redact WooCommerce order tool responses
* Improved: wip: prevent widget send overlap
* Improved: docs: document contributor insight follow-through
* Improved: wip: clarify signed gh write guidance
* Fix: limit benchmark URL normalization to url options
* Improved: test: ensure site health option cleanup
* Improved: docs: document contributor insight guidance
* Fix: add signed feedback issue creation
* Improved: wip: fall back from stale block refs
* Fix: register fresh install site health ability
* Fix: add switch-plugin dry run preview
* Improved: wip: normalize scalar tool results
* Fix: normalize assertion URL to active site
* Improved: wip: localize command palette label
* Improved: wip: document contributor insight triage
* Improved: docs: add headless worker guardrails
* Fix: read proposal function responses
* Fix: repair generated plugin paths and PHP
* Fix: register health endpoint on REST hook
* Fix: canonicalise filesystem mkdir paths
* Fix: omit temperature for Claude Opus 4.7
* Improved: test: stabilize trunk e2e helpers
* New: command palette (Cmd/Ctrl+K) entry
* New: add lint validation to all PHP file-write paths (issue #1829)
* Improved: auto-recover: orphaned worker branch for #1822
* New: post-mutation loopback health check + auto-revert for file writes (Resolves #1822)
* Improved: enforce wp_is_file_mod_allowed per write context
* New: sd-ai-agent/list-allowed-roots
* New: deep-link file paths to plugin-editor.php / theme-editor.php (Resolves #1825)
* New: in-flight proposal panel with live diff + Apply/Reject
* New: SSRF-harden sd-ai-agent/fetch-url
* New: unify file-write rollback into ChangesLog/ChangeRevertService
* Fix: protect enricher dispatch from third-party exceptions (Resolves #1819)
* Fix: DeepSeek V4 Flash 400 — merge split reasoning+tool_calls wire messages (Resolves #1814)
* Improved: test(block-abilities): fix risky test by adding assertNotNull and tier filter
* Improved: test(rate-limiter): add set_up() pre-test isolation to fix order-dependent flake (GH#1811)
* New: block enrichers framework + core/image enricher (t266)
* New: port block-mcp security test suites (t271)
* New: bindings field shape consistency across read abilities (t275)
* Improved: wip: add block comment stripping to sanitize_block_tree
* Improved: security(idor): add per-resource edit_post capability checks to ability handlers
* Improved: security(uploads): add WP_DISABLE_UPLOADS and multisite_can_upload() guards to upload abilities (GH#1803)
* New: port block-mcp stress suite to SdAiAgent (t270)
* Fix: add type declaration to meta_query.items.properties.value in list-posts ability schema
* New: HTTP If-Match/ETag optimistic concurrency on MCP block routes (t269)
* New: add include_inner_blocks flat DFS mode (t274)
* New: add sd-ai-agent/scan-storage-modes ability (t265)
* New: add missing 'type' entries to ability schemas (t272)
* New: filter parity with block-mcp /find-posts (t267)
* New: return null instead of 0 for revisionless posts (t273)
* New: URL / slug+post_type input parity (t268)
* Improved: wave-3 block-mcp worker briefs (t265-t275, For #wave3-parent)
* Fix: close Block Bindings write-lock bypass in update-html/replace-block/remove-block/replace-range/rewrite-post-blocks
* Fix: correct refs_removed/refs_preserved counters in replace-block-range
* Fix: prevent duplicate extension in upload-media base64 (GH#1771)
* Improved: test(rate-limiter): add GH#1772 regression + edge-case coverage for retry_after_seconds
* Improved: fix PluginBuilder/Updater sandbox failures — sync wp-config.php password from wp-tests-config.php
* New: add sd-ai-agent/revert-to-revision ability
* New: add replace_block_range ability — atomic N-for-M swap
* New: per-post rate limiting (write 10/min, rewrite 2/min)
* New: add sd-ai-agent/rewrite-post-blocks ability
* New: implement render:true mode on get-page-blocks
* New: Block Bindings API write-lock + read surfacing
* New: unified upload-media ability with source discriminator
* New: add sd-ai-agent/insert-pattern ability for registered + synced pattern insertion
* New: add sd-ai-agent/list-terms ability for taxonomy term discovery
* New: add sd-ai-agent/resolve-url ability (Wave 2.1, Resolves #1747)
* Improved: file 10 wave-2 worker briefs for block-mcp adoption (t255-t264)
* New: enforce block tier policy on edit-block-tree and update-blocks write paths
* New: add outline/summary_only/search/block_name/render/fields parameters to get-page-blocks
* New: add tier/score/suggested_replacement fields to list-block-types
* Fix: include reasoning_content in DeepSeek thinking-mode API requests (Resolves #1737)
* New: enforce MAX_BLOCK_DEPTH on edit-block-tree write path (Resolves #1734)
* New: block depth cap + structural caps — MAX_BLOCK_DEPTH=32, MAX_BATCH_SIZE=50 (Resolves #1714)
* New: t250 — dual-storage block detection and enforcement (Resolves #1713)
* New: atomic batch block updates with pre-flight validation (Resolves #1709)
* New: auto-transform block innerHTML on attribute changes (Resolves #1711)
* Improved: docs: add REST API security and operational guidelines from contributor insights
* New: block tree mutator with 9-op vocabulary (sd-ai-agent/edit-block-tree)
* New: tier-based block preference policy with admin UI (Resolves #1712)
* New: optimistic concurrency via If-Match revision_id (Resolves #1710)
* New: stable block refs (sd_ref) and sd-ai-agent/get-page-blocks ability (Resolves #1707)
* New: SSRF guard for URL sideload paths
* New: site-wide block/pattern usage analytics — sd-ai-agent/get-site-block-usage (Resolves #1716)
* New: t252 — Tier 3.9 server-side instructions addendum (per-site rule string)
* Improved: file 11 worker briefs for block-mcp pattern adoption (t244-t254)
* Fix: switch lint-staged to use eslint directly for staged files only
* Fix: add error field to success report in block validator
* Fix: preserve self-closing slash when injecting class in BlockValidator
* New: improve loop guard test coverage and simplify assertions (Resolves #1700)
* Improved: remove beads/bd integration
* Fix: make shard-2 tests deterministic — mock /run+/job, WP-CLI pre-scaffold (sd-ai-tu3)
* New: wire save-time gate into create_post + update_post (GH#1584 follow-up)
* Improved: docs(abilities): wp-rest ability reference (docs/wp-rest-ability.md) + agent skill (wp-rest-fallback.md)
* New: implement WpRestAbilities (wp-rest/discover, inspect, execute) #1686
* Fix: enhance error messages to guide model continuation after tool failures
* New: improve skill-disabled error message with helpful context
* New: live wp.blocks.validateBlock() bridge + deep PHP validator (GH#1584)
* New: slim default theme.json to minimal baseline (GH#1593)
* New: vendor WordPress/agent-skills bundle — 5 curated skills (GH#1588)
* New: append diff-interpretation hint when invalidBlocks > 0 (GH#1589)
* New: inject working-cadence section for content-generation turns
* New: core/html content policy + plugin recommendations (GH#1585)
* Improved: docs(skills): add block-theme layout cascade rules to gutenberg-blocks skill
* Fix: use renamed superdav-ai-agent.zip in blueprint download URLs
* Fix: require >1 published post for 'has content' probe
* Fix: split multi-part assistant messages with function_calls (sd-ai-j72)
* Improved: remove redundant Theme Builder photo-upload tile
* Improved: prepare v1.16.1
* Fix: restore Theme Builder chat scroll and re-enable photo upload tile
* Fix: temporarily hide photo-upload tile in Theme Builder
