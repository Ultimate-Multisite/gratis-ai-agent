 ...
 *
 * This ability is supplied only by the separately distributed Superdav AI Agent
 * Advanced companion plugin. It is absent from the core WordPress.org package
 ...
 *
 * The advanced package retains this file as the documented low-level fallback
 * for self-hosted users when no purpose-built ability matches a task.
 *
 * @package SdAiAgent
 * @since 1.1.0
