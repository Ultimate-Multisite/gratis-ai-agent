...
class WpRestAbilities {
	...
	public static function register_category(): void {
		// Feature-gated: the dispatcher surface ships only in the advanced
		// companion plugin and may be disabled per-site via
		// SD_AI_AGENT_FEATURE_WP_REST_DISPATCHER in wp-config.php.
