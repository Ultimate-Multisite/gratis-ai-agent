...
class WpCliAbilities {
	...
	public static function register_category(): void {
		// Feature-gated: the wp-cli/execute ability ships only in the
		// advanced companion plugin and may be disabled per-site via
		// SD_AI_AGENT_FEATURE_WP_CLI_DISPATCHER. Skipping
