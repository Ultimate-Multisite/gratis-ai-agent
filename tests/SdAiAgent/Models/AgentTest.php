...
class AgentTest extends WP_UnitTestCase {
	...
	public function test_onboarding_uses_dedicated_discovery_abilities_instead_of_wp_cli(): void {
		...
		$this->assertStringContainsString( 'Treat any stock response with `success: false`, an `error`, `attachment_id: 0`, or an empty `url` as a failed image acquisition', $prompt );
