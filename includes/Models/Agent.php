...
class Agent {
	...
	private static function build_setup_assistant_prompt( string $site_title, string $site_url ): string {
		...
		$phase_2 = "## Phase 2: Build or explicitly rebuild the homepage\n\n"
			...
			. "21. Inspect the anonymous rendered header and footer before completion. If the user asked to remove default content or navigation, remove or replace every visible default-theme link group in both regions; creating a new primary menu does not remove a separate default footer navigation. On a page-level fallback where supported theme or template-part mutation is unavailable, report that limitation instead of claiming the default navigation was removed.\n"
